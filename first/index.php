...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
		    <h1>Mobile Site<a href="http://centerforintegralhealth.com/" rel="external">  Clasic Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
			  	...
			  	<div class="callbacks_container">
				    <ul class="rslides" id="slider4">
				      <li>
				        <img src="img/slider-images/1slide.jpeg" alt="">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#secondpage" data-transition="<?php echo $transitionefect ?>">About</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#secondpage" data-transition="<?php echo $transitionefect ?>">Patients</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#secondpage" data-transition="<?php echo $transitionefect ?>" >FAQs</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#secondpage" data-transition="<?php echo $transitionefect ?>" >Flu Remedy</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#secondpage" data-transition="<?php echo $transitionefect ?>" >Links</a></div>
				</div>
				...
				<p>
					The Center for Integral Health brings together practitioners dedicated to creating health in the whole person. Physical, emotional and mental wellness are all integral components of total well-being
				</p>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#ourteam" data-transition="<?php echo $transitionefect ?>">Our Staff</a></li>
							<li><a href="http://easternah.vetsfirstchoice.com/" data-transition="<?php echo $transitionefect ?>" rel="external">Shop Online</a></li>
							<li><a href="#secondpage" data-transition="<?php echo $transitionefect ?>">Pet Portals</a></li>
